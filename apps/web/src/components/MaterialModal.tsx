...
import { Crop, Film, Grid3x3, Layers3, MoveHorizontal, Pencil, PersonStanding, RefreshCw, Trash2, Undo2, Wand2, X } from "lucide-react";
...
export type MaterialDetailAction = "crop" | "frame-split" | "actions" | "directions";

/** 素材详情：图片对比滑杆 / 视频预览 + 抽帧编辑器；抠图/还原/导入/删除 */
export default function MaterialModal({ material: m, v, initialAction, onClose, onChanged, onToast }: Props) {
  const t = useT();
  ...
  const [showSplit, setShowSplit] = useState(initialAction === "frame-split");
