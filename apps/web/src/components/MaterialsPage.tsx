...
import { Check, Crop, Download, Eye, Film, Grid3x3, ImageDown, Layers3, Package, Pencil, PersonStanding, RefreshCw, Scan, Sparkles, Trash2, Undo2, Upload, Wand2, X } from "lucide-react";
import { SOURCE_COLORS } from "@ezgameart/shared";
...
export default function MaterialsPage() {
  ...
  const handleDragStart = useCallback((id: string, e: React.DragEvent) => {
    ...
    e.dataTransfer.setData("application/x-ezgameart-ids", JSON.stringify(ids));
  ...
  return (
    <div className="page page-with-folders">
      ...
      <main className="folder-content">
        ...
        <section className="folder-main resource-browser" aria-label={t("msg.materials")}>
          {materials.length === 0 ? (
            <div className="empty">
              <Package size={32} />
